        ...
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-green-600 font-bold text-xl'>
              IRAKA <span className='text-[#1677cccb]'>BIO TECH</span>
            </Link>
          </div>

          <ul className='hidden lg:flex gap-10 text-base'>
            <li>
              <Link to='/'>Find Vaccine</Link>
            </li>
            <li>
              <Link to='/companies'>Animals</Link>
            </li>
            <li>
              <Link
                to={
              ...
              >
                {user?.accountType === "seeker" ? "Applications" : "Add Vaccine"}
              </Link>
            </li>
            <li>
