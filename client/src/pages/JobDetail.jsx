    ...
    <div className='container mx-auto'>
      <div className='w-full flex flex-col md:flex-row gap-10'>
        ...
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
          ...
          <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10'>
            ...
            <div className='bg-[#bae5f4] w-40 h-16 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm'>Type of Vaccine</span>
              <p className='text-lg font-semibold text-gray-700'>
                {job?.jobType}
              </p>
            </div>
            ...
            <div className='bg-[#fed0ab] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center'>
              <span className='text-sm'>Recorded Applications</span>
              <p className='text-lg font-semibold text-gray-700'>
          ...
          <div className='my-6'>
            {selected === "0" ? (
              <>
                <p className='text-xl font-semibold'>Vaccine Decsription</p>

                <span className='text-base'>{job?.detail[0]?.desc}</span>

                {job?.detail[0]?.requirement && (
                  <>
                    <p className='text-xl font-semibold mt-8'>Suitability</p>
              ...
              <>
                ...
                <p className='text-xl font-semibold'>About the Maker</p>
        ...
        <div className='w-full md:w-1/3 2xl:w-2/4 p-5 mt-20 md:mt-0'>
          <p className='text-gray-500 font-semibold'>Similar Vaccines</p>
